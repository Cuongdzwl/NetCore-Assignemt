    ...
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Book != null ? 
                          ...
                          Problem("Entity set 'DbContext.Book'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Publisher,ImagePath,Description,Price,Quantity,CreatedDate")] Book book)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbContext.Book'  is null.");
            }
            var book = await _context.Book.FindAsync(id);
            if (book != null)
            {
